...
class ProfilPedagang extends StatefulWidget {
  @override
  _ProfilPedagangState createState() => _ProfilPedagangState();
}
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CircleAvatar(
                        radius: 25.0,
                        backgroundImage: AssetImage("images/abang2.jpg")
                      ),
                    ),
                  ),
                  Container(
                    ...
                    children: ListTile.divideTiles(
                        ...
                        tiles: [
                          ListTile(
                            ...
                            subtitle: Text('Muhammad Hendriawan', style: TextStyle(color: Colors.black, fontSize: 20)),
                            onTap: (){
                          ...
                          ListTile(
                            ...
                            subtitle: Text('mhendriawan', style: TextStyle(color: Colors.black, fontSize: 20)),
                          ),
                          ListTile(
                          ...
                          ListTile(
                            ...
                            subtitle: Text('mhendriawan1@gmail.com', style: TextStyle(color: Colors.black, fontSize: 20)),
                          ),
                          ListTile(
